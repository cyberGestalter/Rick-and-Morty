...
import com.example.rick_and_morty.databinding.FragmentLocationDetailsBinding
import com.example.rick_and_morty.ui.RickAndMortyAdapter
import com.example.rick_and_morty.ui.activities.DetailActivity
import com.example.rick_and_morty.viewmodel.LocationDetailsViewModel
...
class LocationDetailsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            locationId = it.getInt(LOCATION_ID_EXTRA)
        }
    }
    ...
    private fun setRefreshLayout() =
        RickAndMortyApplication.setRefreshLayout(binding.locationDetailsRefreshLayout) {
            viewModel.updateLocation(locationId)
        }
    ...
    companion object {
        ...
        fun newInstance(locationId: Int) = LocationDetailsFragment().also {
            it.arguments = bundleOf(LOCATION_ID_EXTRA to locationId)
        }
    }
}